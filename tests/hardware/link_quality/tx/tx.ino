// Link-quality probe TX (ESP32IRPulseKit).
//
// Sends a fixed NEC frame on each "SEND NEC <hex>" command from the host
// monitor. The monitor drives this in a loop while you move the boards by hand
// and watches the receive-side score change.
