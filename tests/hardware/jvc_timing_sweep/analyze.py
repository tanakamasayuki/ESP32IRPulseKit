...
Reads the CSV from test_jvc_timing_sweep.py and draws two heatmaps
(rows = zero-space us, cols = bit-mark us):
  ...
  - pass_ratio    : fraction of frames decoded as JVC.
    ...
    uv run --with matplotlib python hardware/jvc_timing_sweep/analyze.py \
        hardware/jvc_timing_sweep/data/jvc_sweep.csv [out.png]
"""
import csv
import sys
