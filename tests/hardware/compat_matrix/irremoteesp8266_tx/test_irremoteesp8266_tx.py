...
class Case:
    # protocol: keyword the IRremoteESP8266 TX peer understands.
    # bits: payload handed to the external library. ESP32IRPulseKit RX may
    # decode it with a different value due to bit-order/field differences,
    # which is exactly what this matrix observes.
    protocol: str
    bits: int
...
def test_irremoteesp8266_tx_to_pulsekit_rx(dut, peers, case, record_property):
    ...
    record_property("tx_impl", "IRremoteESP8266")
