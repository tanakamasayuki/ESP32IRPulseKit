...
# AC encoder verification (Hitachi): our TX (ESP32IRPulseKit, esp32irpk::ac::Hitachi)
# encodes a known standard 28-byte HITACHI_AC state and transmits it; an INDEPENDENT
# receiver (IRremoteESP8266's IRrecv + IRHitachiAc) decodes it. Proves our toRaw()
# produces a burst a third-party stack accepts (including the per-byte bit-reversal
# and the sum checksum).
#
...
def test_hitachi_irremoteesp8266_rx(dut, peers, case, record_property):
