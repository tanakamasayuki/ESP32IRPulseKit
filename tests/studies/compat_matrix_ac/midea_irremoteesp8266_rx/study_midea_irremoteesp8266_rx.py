...
# AC encoder verification (Midea): our TX (ESP32IRPulseKit, esp32irpk::ac::Midea)
# encodes a known standard 48-bit / 6-byte Midea state and transmits it (the data
# followed by an inverted copy); an INDEPENDENT receiver (IRremoteESP8266's IRrecv
# + IRMideaAC) decodes it. Proves our toRaw() produces a double burst a third-party
# stack accepts.
#
...
def test_midea_irremoteesp8266_rx(dut, peers, case, record_property):
