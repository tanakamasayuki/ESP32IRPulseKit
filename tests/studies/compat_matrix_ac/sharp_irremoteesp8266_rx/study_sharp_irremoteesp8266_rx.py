...
# AC encoder verification (Sharp): our TX (ESP32IRPulseKit, esp32irpk::ac::Sharp)
# encodes a known standard 13-byte SHARP_AC state (A907, LSB-first) and transmits it;
# an INDEPENDENT receiver (IRremoteESP8266's IRrecv + IRSharpAc) decodes it. Proves
...
#
# IRSharpAc::getFan() returns the wire code (auto=2/med=3/min=4/high=5/max=7),
# matching our enum values. Temp is a don't-care in Auto/Dry.
...
def test_sharp_irremoteesp8266_rx(dut, peers, case, record_property):
