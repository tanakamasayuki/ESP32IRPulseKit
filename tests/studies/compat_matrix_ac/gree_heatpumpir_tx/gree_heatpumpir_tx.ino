// Compat-AC second reference (Gree) -- RX side (ESP32IRPulseKit).
//
// The peer TX (peer_tx/) is HeatpumpIR's GreeGenericHeatpumpIR over an LEDC
...
// it with esp32irpk::ac::Gree. The harness checks our decoded fields against the
// known sent state (semantic agreement; byte identity is not expected since
// HeatpumpIR fills different auxiliary bytes than IRremoteESP8266).
