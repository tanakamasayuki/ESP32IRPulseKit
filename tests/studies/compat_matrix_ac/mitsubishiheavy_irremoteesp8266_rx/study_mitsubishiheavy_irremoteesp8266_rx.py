...
# AC encoder verification (Mitsubishi Heavy): our TX (ESP32IRPulseKit,
# esp32irpk::ac::MitsubishiHeavy) encodes a known 19-byte MITSUBISHI_HEAVY_152
# state and transmits it; an INDEPENDENT receiver (IRremoteESP8266's IRrecv +
# IRMitsubishiHeavy152Ac) decodes it. Proves our toRaw() produces a burst a
# third-party stack accepts (including the shorter-1-space encoding and the
# inverted byte pairs).
#
...
def test_mitsubishiheavy_irremoteesp8266_rx(dut, peers, case, record_property):
