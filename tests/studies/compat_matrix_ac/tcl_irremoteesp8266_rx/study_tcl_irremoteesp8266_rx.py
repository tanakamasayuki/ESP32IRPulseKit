...
# AC encoder verification (TCL): our TX (ESP32IRPulseKit, esp32irpk::ac::Tcl)
# encodes a known 14-byte TCL112AC state and transmits it; an INDEPENDENT receiver
# (IRremoteESP8266's IRrecv + IRTcl112Ac) decodes it. Proves our toRaw() produces a
# burst a third-party stack accepts and classifies as TCL112AC.
#
...
def test_tcl_irremoteesp8266_rx(dut, peers, case, record_property):
