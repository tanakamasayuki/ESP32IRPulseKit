...
# AC encoder verification (Haier): our TX (ESP32IRPulseKit, esp32irpk::ac::Haier)
# encodes a known standard 9-byte HAIER_AC state and transmits it; an INDEPENDENT
# receiver (IRremoteESP8266's IRrecv + IRHaierAC) decodes it. Proves our toRaw()
# produces a double-header burst a third-party stack accepts.
#
...
# command, set last, so power() = "not the Off command".
...
def test_haier_irremoteesp8266_rx(dut, peers, case, record_property):
