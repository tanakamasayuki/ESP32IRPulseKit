...
# AC encoder verification (Kelvinator): our TX (ESP32IRPulseKit, esp32irpk::ac::
# Kelvinator) encodes a known standard 16-byte Kelvinator state (two blocks) and
# transmits it; an INDEPENDENT receiver (IRremoteESP8266's IRrecv + IRKelvinatorAC)
# decodes it. Proves our toRaw() produces a two-block burst a third-party stack
# accepts.
#
...
# values. Temp is a don't-care in Auto/Dry.
...
def test_kelvinator_irremoteesp8266_rx(dut, peers, case, record_property):
