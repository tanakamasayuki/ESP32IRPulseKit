...
# AC encoder verification (Carrier): our TX (ESP32IRPulseKit, esp32irpk::ac::Carrier)
# encodes a known standard 8-byte / 64-bit CARRIER_AC64 state and transmits it; an
# INDEPENDENT receiver (IRremoteESP8266's IRrecv + IRCarrierAc64) decodes it. Proves
...
def test_carrier_irremoteesp8266_rx(dut, peers, case, record_property):
